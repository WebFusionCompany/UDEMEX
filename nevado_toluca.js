...
const modelUrl1 = 'MAPA_nevado_toluca.glb';
...
function loadModel(url) {
    ...
    if (extension === 'stl') {
        ...
        errorMessage.textContent = 'Formato no soportado. Usa .glb, .gltf o .stl';
...
function loadGLTFModel(url) {
    ...
    loader.load(
        ...
        function (error) {
            ...
            errorMessage.textContent = 'No se pudo cargar el modelo GLTF: ' + (error.message || 'Desconocido');
            errorElement.style.display = 'block';
            loadingElement.style.display = 'none';
        }
    );
...
function loadSTLModel(url) {
    ...
    loader.load(
        ...
        function (error) {
            ...
            errorMessage.textContent = 'No se pudo cargar el modelo STL: ' + (error.message || 'Archivo inválido');
            errorElement.style.display = 'block';
            loadingElement.style.display = 'none';
        }
    );
...
function loadUserModel(event) {
    ...
    if (!validExtensions.includes(extension)) {
        errorMessage.textContent = 'Formato no soportado. Usa archivos .glb, .gltf o .stl';
        errorElement.style.display = 'block';
        return;
    }
